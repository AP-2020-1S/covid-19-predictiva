...
def rollPlot(ciudad, case='acumulado_dia_confirmados'):
    ts=data.loc[(data['ciudad_de_ubicaci_n']==ciudad)]  
    ts=ts[['fecha_reporte_web',case]]
    ts=ts.set_index('fecha_reporte_web')
    ts.astype('int64')
...
tsC3=roll('Barranquilla')
rollPlot('Barranquilla')

tsC4=roll('Cartagena de Indias')
rollPlot('Cartagena de Indias')

tsC5=roll('Bogotá D.C.')
rollPlot('Bogotá D.C.')
...
#Para Medellín
tsC=tsC1['acumulado_dia_confirmados'].values
stationarity(tsC)

#Para Cali
tsC=tsC2['acumulado_dia_confirmados'].values
stationarity(tsC)

#Para Barranquilla
tsC=tsC3['acumulado_dia_confirmados'].values
stationarity(tsC)

#Para Cartagena de Indias
tsC=tsC4['acumulado_dia_confirmados'].values
stationarity(tsC)

#Para Bogotá D.C.
tsC=tsC5['acumulado_dia_confirmados'].values
stationarity(tsC)
...
y1 = features_and_target_train[['acumulado_dia_confirmados']]
